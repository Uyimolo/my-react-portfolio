...
const Project = ({ project }) => {
  ...
  return (
    // out wrapper
    <div className="bg-[url('./images/project-images/react-weather-mobile-bg.png')] bg-cover  rounded-3xl mx-auto min-w-80 max-w-[22rem] md:mx-0 md:max-w-[40rem] lg:max-w-[50rem] hover:bg-contain transition duration-700  ">
      {/* inner wrapper  */}
