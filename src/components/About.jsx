...
const About = () => {
  return (
    <section className="px-6 flex flex-col space-y-4 h-full pb-12 md:px-16  xl:px-28">
      <h2 className="text-2xl text-gray-200 md:text-center lg:text-3xl ">Introductions</h2>
      <p className="text-gray-400 md:max-w-2xl md:text-center md:mx-auto lg:max-w-3xl lg:text-xl ">
